function [bits, ofdmDemodData, varargout] = funcWlanHTDataRecover( ...
...
% OFDM demodulation
%%%%%***HT Data Demodulation***%%%%%%
[ofdmDemodData, ofdmDemodPilots] = wlan.internal.wlanOFDMDemodulate(rxHTData(1:minInputLen, :), cfgOFDM, recParams.OFDMSymbolOffset);

%%%%%***HT Data Phase Tracking***%%%%%%
...
% Equalization
%%%%%***HT Data Equalization***%%%%%%
if numSS < numSTS
    [eqDataSym, csiData] = wlan.internal.wlanSTBCCombine(ofdmDemodData, chanEstData, numSS, recParams.EqualizationMethod, noiseVarEst);
else    
    [eqDataSym, csiData] = wlan.internal.wlanEqualize(ofdmDemodData, chanEstData, recParams.EqualizationMethod, noiseVarEst);
end
